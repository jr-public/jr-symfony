...
class UserRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function findWithFilters(UserListFiltersDTO $filters): array
    {
    ...
    private function applyFilters(QueryBuilder $qb, UserListFiltersDTO $filters): void
    {
    ...
    private function applySorting(QueryBuilder $qb, UserListFiltersDTO $filters): void
    {
        $allowedSortFields = [
            'username' => 'u.username',
            'email' => 'u.email',
