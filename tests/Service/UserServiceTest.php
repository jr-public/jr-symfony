...
final class UserServiceTest extends KernelTestCase
{
    ...
    public function testCreateUserPersistsToDatabase(): void
    {
        ...
        $this->assertContains(UserRole::User, $savedUser->getRoles());
    ...
    public function testCreateAdminUserWithCorrectRole(): void
    {
        ...
        $this->assertInstanceOf(User::class, $savedUser);
		$this->assertContains(UserRole::User, $savedUser->getRoles());
		$this->assertContains(UserRole::Admin, $savedUser->getRoles());
    }
    ...
    private function cleanDatabase(): void
    {
        ...
        try {
            $connection->executeStatement('TRUNCATE TABLE token, "user" RESTART IDENTITY CASCADE');
        } catch (\Exception $e) {
